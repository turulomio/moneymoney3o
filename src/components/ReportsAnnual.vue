        ...
        data(){
            return {
                ...
                total_annual_headers: [
                    ...
                    { text: this.$t('Account balance'), value: 'account_balance', sortable: false, align:'end', width:"17%"},
                    { text: this.$t('Investment balance'), value: 'investment_balance', sortable: false, align:'end', width:"17%"},
                    { text: this.$t('Total balance'), value: 'total',sortable: false, align:'end', width:"17%"},
                    { text: this.$t('Last month difference'), value: 'diff_lastmonth', sortable: false, align:'end', width:"17%"},
                    { text: this.$t('% year to date'), value: 'percentage_year', sortable: false, align:'end', width:"17%"},
                ],   
                total_annual_incomes:[],
                total_annual_incomes_headers: [
                    { text: this.$t('Month'), value: 'month',sortable: true , width:"12.5%"},
                    { text: this.$t('Incomes'), value: 'incomes', sortable: true, align:'end', width:"12.5%"},
                    { text: this.$t('Expenses'), value: 'expenses', sortable: true, align:'end', width:"12.5%"},
                    { text: this.$t('Gains'), value: 'gains',sortable: true, align:'end', width:"12.5%"},
                    { text: this.$t('Fast operations'), value: 'fast_operations',sortable: true, align:'end', width:"12.5%"},
                    { text: this.$t('Dividends'), value: 'dividends', sortable: true, align:'end', width:"12.5%"},
                    { text: this.$t('Total'), value: 'total', sortable: true, align:'end', width:"12.5%"},
                ],     
                total_annual_gainsbyproductstypes:[],
                total_annual_gainsbyproductstypes_headers: [
                    { text: this.$t('Name'), value: 'name',sortable: true},
                    { text: this.$t('Gross gains'), value: 'gains_gross', sortable: true, align:'end', width:"22%"},
                    { text: this.$t('Gross dividends'), value: 'dividends_gross', sortable: true, align:'end', width:"22%"},
                    { text: this.$t('Net gains'), value: 'gains_net',sortable: true, align:'end', width:"22%"},
                    { text: this.$t('Net dividends'), value: 'dividends_net', sortable: true, align:'end', width:"22%"},
                ],   
                total_target:[],
                total_target_headers: [
                    { text: this.$t('Month'), value: 'month',sortable: true },
                    { text: this.$t('Month target'), value: 'month_target',sortable: true,align:'end', width:"22%"},
                    { text: this.$t('Month gains'), value: 'month_gains', sortable: true, align:'end', width:"22%"},
                    { text: this.$t('Cumulative target'), value: 'cumulative_target', sortable: true, align:'end', width:"22%"},
                    { text: this.$t('Cumulative gains'), value: 'cumulative_gains',sortable: true, align:'end', width:"22%"},
                ],   
                total_invest_or_work:[],
                total_invest_or_work_headers: [
                    { text: this.$t('Month'), value: 'month',sortable: true },
                    { text: this.$t('Gains'), value: 'gains',sortable: true,align:'end', width:"27%"},
                    { text: this.$t('Expenses'), value: 'expenses', sortable: true, align:'end', width:"27%"},
                    { text: this.$t('Diff'), value: 'diff', sortable: true, align:'end', width:"27%"},
                ],    
                total_make_ends_meet:[],
                total_make_ends_meet_headers: [
                    { text: this.$t('Month'), value: 'month',sortable: true },
                    { text: this.$t('Incomes'), value: 'incomes',sortable: true,align:'end', width:"27%"},
                    { text: this.$t('Expenses'), value: 'expenses', sortable: true, align:'end', width:"27%"},
                    { text: this.$t('Diff'), value: 'diff', sortable: true, align:'end', width:"27%"},
                ],   
