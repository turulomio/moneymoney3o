    ...
    <div>
        ...
        <v-card class="ma-4 pa-4">   
            ...
            <v-form ref="form" v-model="form_valid" lazy-validation>             
                ...
                <v-autocomplete :items="store().getInvestmentsByProduct(newpr.product)" v-model="newpr.investments" :label="$t('Select investments to include')" item-title="fullname" item-value="id" multiple :rules="RulesSelection(true)" chips></v-autocomplete>
