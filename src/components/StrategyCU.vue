    ...
    <div>    
        ...
        <v-card class="pa-8 mt-2">
            <v-form ref="form" v-model="form_valid" lazy-validation>
                ...
                <v-autocomplete dense :readonly="deleting" :items="store().investments" v-model="temporal_investments" :label="$t('Select strategy investments')" item-text="fullname" item-value="id" multiple :rules="RulesSelection(true)" chips></v-autocomplete>
                ...
                <v-select :readonly="deleting" dense :items="store().strategiestypes" v-model="newstrategy.type" :label="$t('Select strategy type')" item-text="name" item-value="id" :rules="RulesSelection(true)" @change="on_strategy_type_change()"></v-select>
                ...
                <v-select class="mr-5" :items="store().recomendation_methods" v-model="recomendation_method"  item-text="name" item-value="id" :rules="RulesSelection(true)" v-if="recomendation_method_visibility" :label="this.$t('Select a recomendation method')"></v-select>  
