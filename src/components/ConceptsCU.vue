    ...
    <div>    
        ...
        <v-card class="pa-8 mt-2">
            <v-form ref="form" v-model="form_valid" lazy-validation>
                ...
                <v-autocomplete :readonly="deleting || editing" dense :items="store().getOperationstypesForNewConcepts()" v-model="newconcept.operationstypes" :label="$t('Select an operation type')" item-title="localname" item-value="url" :rules="RulesSelection(true)"></v-autocomplete>
            </v-form>
            <v-card-actions>
                <v-spacer></v-spacer>
