        ...
        data(){ 
            return {
                ...
                data_price_ratio_headers:[
                    ...
                    { text: this.$t('Date and time seconds diff'), sortable: true, value: 'diff', align:'end'},
                    { text: this.$t('Better price'), value: 'price_better', align:'end'},
                    { text: this.$t('Worse price'), value: 'price_worse', align:'end'},
                    { text: this.$t('Price ratio'), value: 'price_ratio', align:'end'},
                    { text: this.$t('Percentage from start'), value: 'price_ratio_percentage_from_start', align:'end'},
                ],
                ...
                comparation_by_quote_headers:[
                    ...
                    { text: this.$t('Better quote'), value: 'better_quote',   align:'end'},
                    { text: this.$t('Worse date and time'), sortable: true, value: 'worse_datetime'},
                    { text: this.$t('Worse quote'), value: 'worse_quote', align:'end'},

                    { text: this.$t('Minutes apart'), value: 'minutes_apart',align:'end'},
