            ...
            table_headers(){
                ...
                if (this.output=="account"){
                    r= [
                        ...
                        { text: this.$t('Price'), value: 'price',sortable: false, align:'end'},
                        { text: this.$t('Gross'), value: 'gross_account',sortable: false, align:'end'},
                        { text: this.$t('Commission'), value: 'commission',sortable: false, align:'end'},
                        { text: this.$t('Taxes'), value: 'taxes',sortable: false, align:'end'},
                        { text: this.$t('Net'), value: 'net_account',sortable: false, align:'end'},
                        { text: this.$t('Currency factor'), value: 'currency_conversion',sortable: false, align:'end'},
                    ...
                    r= [
                        ...
                        { text: this.$t('Shares'), value: 'shares',sortable: false, align:'end'},
                        { text: this.$t('Price'), value: 'price',sortable: false, align:'end'},
                        { text: this.$t('Gross'), value: 'gross_investment',sortable: false, align:'end'},
                        { text: this.$t('Commission'), value: 'commission',sortable: false, align:'end'},
                        { text: this.$t('Taxes'), value: 'taxes',sortable: false, align:'end'},
                        { text: this.$t('Net'), value: 'net_investment',sortable: false, align:'end'},
                        { text: this.$t('Currency factor'), value: 'currency_conversion',sortable: false, align:'end'},
                        { text: this.$t('Comment'), value: 'comment',sortable: false},
                    ]
                } else if (this.output=="user"){
                    r= [
                        ...
                        { text: this.$t('Shares'), value: 'shares',sortable: false, align:'end'},
                        { text: this.$t('Price'), value: 'price',sortable: false, align:'end'},
                        { text: this.$t('Gross'), value: 'gross_user',sortable: false, align:'end'},
                        { text: this.$t('Commission'), value: 'commission',sortable: false, align:'end'},
                        { text: this.$t('Taxes'), value: 'taxes',sortable: false, align:'end'},
                        { text: this.$t('Net'), value: 'net_user',sortable: false, align:'end'},
                        { text: this.$t('Currency factor'), value: 'currency_conversion',sortable: false, align:'end'},
                        { text: this.$t('Comment'), value: 'comment',sortable: false},
                    ]
                }
