    ...
    <div>
        ...
        <v-card class="ma-4 pa-4">   
            ...
            <v-form ref="form" v-model="form_valid" lazy-validation>             
                ...
                <v-autocomplete :items="$store.getters.getInvestmentsByProduct(newpr.product)" v-model="newpr.investments" :label="$t('Select investments to include')" item-title="fullname" item-value="id" multiple :rules="RulesSelection(true)" chips></v-autocomplete>
    ...
    export default {
        ...
        data(){ 
            return {
                ...
                chart: '',                
                tableHeaders: [
                    { text: 'Value', key: 'value',sortable: true, width:"7%"},
                    { text: 'Must Invest', key: 'recomendation_invest',sortable: false, width:"5%"},
                    { text: 'Investments',  sortable: false, key: 'investments_inside'},
                    { text: 'Orders',  sortable: false, key: 'orders_inside'},
                    { text: 'Actions', key: 'actions', sortable: false , width:"7%"},
                ],   
