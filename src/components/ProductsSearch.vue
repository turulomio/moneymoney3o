        ...
        data () {
            return {
                ...
                tableHeaders: [
                    ...
                    { text: 'Yahoo',  sortable: true, key: 'ticker_yahoo',width:"6%"},
                    { text: 'Morningstar',  sortable: true, key: 'ticker_morningstar',width:"6%"},
                    { text: 'Google',  sortable: true, key: 'ticker_google',width:"6%"},
                    { text: 'QueFondos',  sortable: true, key: 'ticker_quefondos',width:"6%"},
                    { text: 'Investing.com',  sortable: true, key: 'ticker_investingcom',width:"6%"},
