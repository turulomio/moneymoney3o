        ...
        data(){
            return {
                ...
                assetsHeaders: [
                    ...
                    { text: this.$t('Initial balance'), value: 'balance_start',sortable: true, align:'end'},
                    { text: this.$t('Final balance'), value: 'balance_end',sortable: true, align:'end'},
                    { text: this.$t('Difference'), value: 'diff',sortable: true, align:'end'},
                    { text: this.$t('Incomes'), value: 'incomes',sortable: true, align:'end'},
                    { text: this.$t('Net gains'), value: 'gains_net',sortable: true, align:'end'},
                    { text: this.$t('Net dividends'), value: 'dividends_net',sortable: true, align:'end'},
                    { text: this.$t('Expenses'), value: 'expenses',sortable: true, align:'end'},
                    { text: this.$t('Total'), value: 'total',sortable: true, align:'end'},
                ],   
                assetsData: [],
                investedHeaders: [
                    { text: this.$t('Year'), value: 'year',sortable: true, width:"8.5%" },
                    { text: this.$t('Invested balance'), value: 'invested',sortable: true, align:'end', width:"11.5%" },
                    { text: this.$t('Balance'), value: 'balance',sortable: true, align:'end', width:"11.5%" },
                    { text: this.$t('Difference'), value: 'diff',sortable: true, align:'end', width:"11.5%" },
                    { text: this.$t('Percentage'), value: 'percentage',sortable: true, align:'end', width:"11.5%" },
                    { text: this.$t('Net gains + Dividends'), value: 'net_gains_plus_dividends',sortable: true, align:'end', width:"11.5%" },
                    { text: this.$t('Custody commissions'), value: 'custody_commissions',sortable: true, align:'end', width:"11.5%" },
                    { text: this.$t('Taxes'), value: 'taxes',sortable: true, align:'end', width:"11.5%" },
                    { text: this.$t('Investment commissions'), value: 'investment_commissions',sortable: true, align:'end', width:"11.5%" },
                ],   
                investedData: [],
