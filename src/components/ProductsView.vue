...
<script>     
    ...
    export default {
        ...
        data () {
            return {
                displayvalues:[
                    {title:this.$t('Leverage'), key: this.getObjectPropertyByUrl("leverages",this.product.leverages,"localname")},
                    {title:this.$t('Currency'), key: this.product.currency},
                    {title:this.$t('Obsolete'), key: this.product.obsolete},
                    {title:this.$t('Id'), key: this.product.id},
                    {title:this.$t('Ticker Yahoo'), key: this.product.ticker_yahoo},
                    {title:this.$t('Ticker Morningstar'), key: this.product.ticker_morningstar},
                    {title:this.$t('Ticker Google'), key: this.product.ticker_google},
                    {title:this.$t('Ticker QueFondos'), key: this.product.ticker_quefondos},
                    {title:this.$t('Ticker Investing.com'), key: this.product.ticker_investingcom},
                ],
                items: [
                    {
                ...
                percentage_headers: [
                    ...
                    { title: this.$t('Total'), key: 'm13', sortable: true,align:'end' },
                ],
                quotes_headers: [
                    { title: this.$t('Year'), key: 'year', sortable: true },
                    { title: this.$t('January'), key: 'm1', sortable: true,align:'end' },
