        ...
        data () {
            return {
                ...
                tableHeaders: [
                    ...
                    { text: this.$t('Last'), value: 'last',sortable: true,align:'end',width:"6%"},
                    { text: this.$t('% last year'), value: 'percentage_last_year',sortable: true, align:'end',width:"6%"},
                ...
                if (this.search==null || this.search==""){
                    ...
                    .then((response) => {
                            response.data.data.forEach(o=>{
                                var p=this.getObjectByUrl("products",o.product)
                                p.last=o.last
