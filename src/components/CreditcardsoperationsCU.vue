    ...
    <div>    
        ...
        <v-card class="pa-6">
            <v-form ref="form_cco" v-model="form_valid_cco" lazy-validation>
                <v-autocomplete :readonly="deleting" :items="store().creditcards.filter(v =>v.active==true)" v-model="newcco.creditcards" :label="$t('Select a credit card')" item-title="name" item-value="url" :rules="RulesSelection(true)"></v-autocomplete>
                ...
                <v-autocomplete :readonly="deleting" autoindex="0" :items="store().concepts" v-model="newcco.concepts" :label="$t('Select a concept')" item-title="localname" item-value="url" :rules="RulesSelection(true)" autofocus></v-autocomplete>
