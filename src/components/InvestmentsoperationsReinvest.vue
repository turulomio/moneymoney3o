<template>
    <div>
        ...
        <v-card class="pa-4 mb-3 mt-3"  >
            ...
            <v-row>
                <v-select class="mr-5" :disabled="loading || (plio_id_after==null)" :items="viewoptions" v-model="viewoption" :label="$t('Set a view option')"  item-title="name" item-value="id" :rules="RulesSelection(true)" @change="refreshTables"></v-select>  
